...
int main(int argc, char* argv[]) {
    ...
    demo::MotorController* motor_controller = new demo::MotorController(app_root + "/DBCs/20220510_Gen5_CAN_DB.dbc");
    ...
    qmlRegisterSingletonInstance<demo::MotorController>("CAN.MotorController", 1, 0, "MotorController", motor_controller);
