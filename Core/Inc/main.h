...
#define GPIO_BRAKE_SWITCH_Pin GPIO_PIN_4
#define GPIO_BRAKE_SWITCH_GPIO_Port GPIOG
#define GPIO_PUMP_Pin GPIO_PIN_5
#define GPIO_PUMP_GPIO_Port GPIOG
#define USB_PowerSwitchOn_Pin GPIO_PIN_6
#define USB_PowerSwitchOn_GPIO_Port GPIOG
#define USB_OverCurrent_Pin GPIO_PIN_7
#define USB_OverCurrent_GPIO_Port GPIOG
#define GPIO_START_BTN_Pin GPIO_PIN_8
...
#define GPIO_RTD_BUZZER_Pin GPIO_PIN_11
#define GPIO_RTD_BUZZER_GPIO_Port GPIOG
#define GPIO_BRAKE_LIGHT_Pin GPIO_PIN_13
#define GPIO_BRAKE_LIGHT_GPIO_Port GPIOG
#define GPIO_START_BTNG14_Pin GPIO_PIN_14
#define GPIO_START_BTNG14_GPIO_Port GPIOG
